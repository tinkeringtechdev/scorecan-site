...
DROP TABLE IF EXISTS manual_standings;
...
CREATE TABLE tournaments (
    ...
    standings_source  ENUM('calculated','manual') NOT NULL DEFAULT 'calculated',
...
-- ----------------------------------------------------------
-- manual_standings — used when tournaments.standings_source = 'manual'
-- ----------------------------------------------------------
CREATE TABLE manual_standings (
    id            INT UNSIGNED NOT NULL AUTO_INCREMENT,
    tournament_id INT UNSIGNED NOT NULL,
